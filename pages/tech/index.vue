      ...
      <div class="body w-full">
        <div class="py-6 sm:py-8 md:py-10">
          <div class="inline-block relative">
            ...
            <div
              class="headline-underline absolute left-0 top-6 sm:top-8 md:top-10 w-full h-3 bg-purple-500 sm:h-4 transform translate-y-[-50%]"
            ></div>
          </div>
        </div>
...
const { articles, loading, error } = useTechNews();
